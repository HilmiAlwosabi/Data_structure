...
public class Q5   {
    ...
    public Node(E e, Node<E> n, Node<E>h ) { 
      element = e; 
      next = n; 
      head = h;
    }
...
// Set a pointer to the head of the original list, L

 
// Traverse through the original list, adding each node to either L1 or L2 in alternating order 
while (current != null) {
